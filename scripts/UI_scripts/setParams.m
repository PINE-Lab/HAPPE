...
while true
    ...
    if reprocessing
        if isfield(params, 'paradigm')
            if params.paradigm.ERP.on
                changeMessage = ['ERP filters, segmentation, interpolation, ' ...
        ...
        if isfield(params, 'paradigm')
            if params.paradigm.task
                if params.paradigm.ERP.on
                    changeMessage = ['onset tags, ERP filters, ' ...
                        'file import information, channels of interest,\n' ...
                        'line noise frequency, line noise reduction, resampling, ' ...
                    ...
                    changeMessage = ['onset tags, file import information, ' ...
                        ...
                        'line noise reduction, resampling, bad channel ' ...
                        'detection,\nwavelet thresholding, muscIL, ' ...
                        'segmentation, interpolation, segment rejection,\n' ...
                        're-referencing, save format, visualizations.\n' ...
                        changeMessage] ;
                end
                ...
                changeMessage = ['file import information, channels of ' ...
                    ...
                    ' resampling, bad channel detection, wavelet\n' ...
                    'thresholding, muscIL, segmentation, interpolation, ' ...
                    'segment rejection,\nre-referencing, save format, ' ...
                    'visualizations.\n' changeMessage] ;
            end
        end
    ...
    %% ERP FILTER CUT-OFFS
    if params.paradigm.ERP.on && (~preExist || strcmpi(paramChoice, 'ERP filters'))
        params.paradigm.ERP.lowpass = input(['Enter low-pass filter, ' ...
            'in Hz:\nCommon low-pass filter is 30 - 45 Hz.\n> ']) ;
        params.paradigm.ERP.highpass = input(['Enter high-pass filter,' ...
    ...
    %% FILTER
    if ~preExist || strcmpi(paramChoice, 'filter')
